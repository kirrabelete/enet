...
<head>
    ...
    <title>enet | Forgot Password</title>
...
<div class="register-box">
    ...
    <div class="register-box-body">
        <p class="login-box-msg">fill out the fields below to verify who you are</p>
        <g:form controller="user" action="validateUser" method="post">
