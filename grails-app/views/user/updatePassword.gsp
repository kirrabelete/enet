...
<head>
    ...
    <title>enet | Update Password</title>
...
<div class="register-box">
    ...
    <div class="register-box-body">
        <p class="login-box-msg">fill out the fields below to change your password</p>
        <g:form controller="user" action="changePassword" method="post" params="[userId: user.id]">
            <div class="form-group has-feedback">
                <input type="password" name="newPassword" autofocus="true" id="password" class="form-control password" placeholder="Password" required>
